...
def iterate_batches(env, net, batch_size):
    ...
    while True:
        ...
        # .data = Extract the data field from the NN output
        # .numpy = Convert the tensors from the data field into numpy array
        # [0] = Extract the first element of the network output. This is where 
        #    the probability distribution are stored. The second element of the
        #    network output stores the gradient functions 
...
if __name__ == '__main__':
    ...
    for iter_no, batch in enumerate(iterate_batches(env, net, BATCH_SIZE)):
        ...
        obs_v, acts_v, reward_b, reward_m = filter_batch(batch, 30)
